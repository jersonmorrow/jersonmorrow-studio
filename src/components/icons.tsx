...
export function LinkedInIcon() {
  return (
    ...
    >
      <g clipPath="url(#clip0_9914_10)">
        <path
          d="M22.225 0H1.77C.79 0 0 .774 0 1.729v20.541C0 23.227.792 24 1.77 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.205 0 22.222 0zM7.35 20.667H3.897V9h3.451v11.667zM5.625 7.433a2.064 2.064 0 01-2.064-2.065 2.065 2.065 0 112.064 2.065zM20.667 20.667h-3.45v-5.9c0-1.41-.025-3.222-1.961-3.222-1.961 0-2.262 1.535-2.262 3.123v5.999h-3.45V9h3.312v1.588h.046c.461-.872 1.587-1.79 3.267-1.79 3.497 0 4.141 2.303 4.141 5.301v6.568z"
          fill="currentColor"
        />
      </g>
      <defs>
